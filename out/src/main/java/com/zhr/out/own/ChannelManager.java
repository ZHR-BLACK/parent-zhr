...
public class ChannelManager {
    ...
    public static IChannel getInterByChannelCode(String channelCode, String jobCode) throws Exception {
        ...
        Class<?> cls = Class.forName(fullClassName.toString().trim());
        return (IChannel) cls.newInstance();
    }

//    public static Map<String, IChannel> getByInterface() {
//        Map<String, IChannel> processorBeanMap = null;
//        try {
//            ApplicationContext context = ServiceLocator.getContext();
//            System.out.println("context==================" + context);
//            processorBeanMap = ServiceLocator.getContext().getBeansOfType(IChannel.class);
//        } catch (BeansException e) {
//            throw new RuntimeException("加载脚本处理器Bean失败！");
//        }
//        return processorBeanMap;
//    }
    ...
    private static ArrayList<Class> getAllClass(String packagename) {
        ...
        for (String className : classNameList) {
            try {
                ...
                logger.error("load class from name failed:" + className + e.getMessage());
